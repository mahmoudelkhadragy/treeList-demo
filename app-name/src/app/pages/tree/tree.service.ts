...
export class TreeService {
 ViewID:string="1";
 vi=[{Name:"Ali",ID:1,Head_ID:"-1"},{Name:"Mona",ID:2,Head_ID:"1"}];
  ...
  GetData(ViewNo:string , langCode:string){
    debugger;
 return this.http.get("https://localhost:44373/api/LoadData?viewNo="+ViewNo);
  }
}
